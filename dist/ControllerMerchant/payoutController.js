...
const PayoutTransaction = {
    filter: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const user = req.user;
        const { id, searchText, to, from, status, currency, From, To, page = 1, limit = 10, } = req.body;
    ...
    payoutheader: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b, _c, _d, _e;
        try {
            ...
            const successData = yield (0, db_connection_1.default)(finalQuery, ["SUCCESS", ...parameters]);
            const declinedData = yield (0, db_connection_1.default)(finalQuery, ["FAILURE", ...parameters]);
            const pendingData = yield (0, db_connection_1.default)(finalQuery, ["PENDING", ...parameters]);
            ...
            const chargeAmount = ((_d = successData[0]) === null || _d === void 0 ? void 0 : _d.charge) !== null && ((_e = successData[0]) === null || _e === void 0 ? void 0 : _e.charge) !== undefined
    ...
    viewDetails: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const user = req.user;
        const ID = user.account_type === 3 ? user.parent_id : user.id;
        const { uniqueid, id } = req.body;
        try {
            ...
            const result = yield (0, db_connection_1.default)(sql, [uniqueid, userIdToUse]);
            res.status(200).json({
    ...
    downloadReport: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const user = req.user;
        ...
        try {
            ...
            resultData.forEach((row, index) => {
                ...
                const statusLabel = ((_a = row.status) === null || _a === void 0 ? void 0 : _a.toUpperCase()) || "UNKNOWN";
                worksheet.addRow([
                    index + 1,
